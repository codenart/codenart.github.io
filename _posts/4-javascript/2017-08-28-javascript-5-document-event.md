...
just get to know how to use it to manipulate HTML document. Before taking the
discussion, please have a quick parse through the following reference link in
which all the bundled stuff of the object `document` are fully listed:
